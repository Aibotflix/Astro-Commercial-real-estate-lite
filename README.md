...
- **96 Lighthouse Performance** — Near-perfect out of the box. The last few points come from the demo using external Unsplash images; swap in your own locally hosted images and it hits 100.
